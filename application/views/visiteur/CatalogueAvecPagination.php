...
<div class="container-fluid text-center"> 
    <div class="row content">
        <div class="col-sm-2 sidenav">
            <p><a href="<?php echo site_url('visiteur/listerLesProduitsAvecPagination') ?>">Lister tous les produits</a></p>
            <!--<p><a href="#">Livres</a></p>
            <p><a href="#">Figurines</a></p>
            <p><a href="#">Posters</a></p>
            POUR FAIRE DES LIENS AVEC SELECTION DE PRODUITS PAR CATEGORIE !!! -->
        </div>
    </div>
</div>
...
<div align="center">
<p><h4><?php echo $liensPagination ?></h4></p>
</div>